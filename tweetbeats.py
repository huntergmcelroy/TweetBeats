...
ACCESS_ID ='AKIAJV6NCQLKCFABGJGQ'
SECRET_KEY = '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'
...
class TweetCollector():
    consumer_key = "aWXhXt4pQqJQL6cULEOJfA"
    consumer_secret = "O9y0MX3xC1M6sGqMLBe8RPeMgaWj4hcr5S0WX3uHCM"
    access_key = "370317318-r8v6ztyC0GqaFpWW3AxZfeTTmDJuhBuxmT6fVpWy"
    access_secret = "J4V8V04q4vlvIQ1Va552qgKAeT4S1cLEmRwm2FMnp0i2S"
    auth = None
    api = None
...
def main(argv):
	if (len(argv) < 2):
		...
		print "Removing unused HITs... Pass #2 0f 5"
		sleep(20)
		hits = mtc.get_all_hits()
		for hit in hits:
			mtc.disable_hit(hit.HITId)
